...
REM Minecraft version 1.20.1
powershell.exe -command "& Invoke-WebRequest -OutFile server.jar -Uri https://www.oracle.com/java/technologies/downloads/#jdk20-windows"
